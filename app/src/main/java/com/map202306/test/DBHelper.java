...
public class DBHelper extends SQLiteOpenHelper {
    private static String TAG = "DBHelper"; //Logcat에 출력할 태그이름
    ...
    private static String DB_NAME ="toilet.db";
    ...
    public boolean openDataBase() throws SQLException //import class 안드로이드.데이터베이스냐 자바.sql이냐
    {
